...
class Vivienda(models.Model):
    ...
    ori_vivienda = models.CharField(verbose_name="Orientación", max_length=30, choices=ORIENTACION_VIVIENDA,default=norte)
    estado_vivienda = models.CharField(verbose_name="Estado vivienda", max_length=30, choices=IS_DISPONIBLE_CHOICES,default=disponible)
...
class Bodega(models.Model):
    ...
    id_vivienda = models.ForeignKey(Vivienda, verbose_name="Vivienda", on_delete=models.CASCADE)
