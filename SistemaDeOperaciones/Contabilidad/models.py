...
class Pago(models.Model):
    ...
    id_reserva = models.CharField(verbose_name="Forma Pago", max_length=30, blank=True, null=True)
    id_venta =  models.CharField(verbose_name="Venta", max_length=30, blank=True, null=True)
    ...
    numero_documento = models.CharField(verbose_name="N° Documento",max_length=10, blank=True, null=True)
    numero_serie = models.CharField(verbose_name="N° Serie",max_length=10, blank=True, null=True)
