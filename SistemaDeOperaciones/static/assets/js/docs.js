...
function() {
    ...
    Waves.attach(".nav-tabs .nav-item .nav-link"),
    ...
    window.addEventListener("resize", function(e) {
        window.outerWidth >= window.Helpers.LAYOUT_BREAKPOINT && document.querySelector(".search-input-wrapper") && (document.querySelector(".search-input-wrapper").classList.add("d-none"),
    ...
    document.getElementById("vertical-nav") && new bootstrap.ScrollSpy(document.body,{
        target: "#vertical-nav"
    }))
}(),
$(function() {
